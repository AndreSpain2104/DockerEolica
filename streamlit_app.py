...
# --- ACERCA DE ---
    ...
    Para más información, sugerencias o reportar problemas con la aplicación, 
    por favor contactar a través de los canales disponibles en el repositorio GitHub.
    """)
    ...
    with col1:
        st.markdown("""
        #### Energía Eólica
        - [IRENA - Energía Eólica](https://www.irena.org/wind)
    ...
    with col2:
        st.markdown("""
        #### Colombia
        - [UPME](https://www1.upme.gov.co/)
        - [XM - Portal BI](https://www.xm.com.co/)
        """)
